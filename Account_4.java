...
class SavingAccount extends Account_4 {
...
class CheckingAccount extends Account_4 {
...
{
Account_4 a1=new Account_4();
Account_4 a2=new Account_4(123456,100000); a2.setdata(1289031,100000,5.6,"2-8-2022");
System.out.println("Account Details: "); System.out.println("Balance : "+a2.balance); System.out.println("Annual Interest : "+a2.getAnn()); System.out.println("Monthly Interest Rate :"+a2.getMonthlyInterestRate()); 
System.out.println("Monthly Interest :"+a2.getMonthlyInterest()); 
System.out.println("Account was created on :"+a2.getDt());
a2.withdraw(12000); a2.deposit(15000);
System.out.print("	\n"); SavingAccount a=new SavingAccount(900); CheckingAccount b=new CheckingAccount(1000); System.out.println("For Saving Account : "); System.out.println(a);
System.out.print("	\n"); System.out.println("For Checking Account : "); System.out.println(b);
}
}
